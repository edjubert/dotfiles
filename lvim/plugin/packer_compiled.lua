...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/edjubert/.local/share/lunarvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["animate.vim"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/animate.vim",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/copilot.vim",
  ...
  ["leap.nvim"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/leap.nvim",
    url = "https://github.com/ggandor/leap.nvim"
  },
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  ["lua-dev.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/opt/lua-dev.nvim",
  ...
  ["mongo-nvim"] = {
    config = { "\27LJ\2\n<\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\1K\0\1\0\nsetup\15mongo-nvim\frequire\0" },
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/mongo-nvim",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/nvim-colorizer.lua",
    url = "https://github.com/norcalli/nvim-colorizer.lua"
  },
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["onedarker.nvim"] = {
    ...
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/onedarker.nvim",
  ...
  ["trouble.nvim"] = {
    ...
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/trouble.nvim",
    url = "https://github.com/folke/trouble.nvim"
  },
  ["vim-easymotion"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/vim-easymotion",
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/vim-go",
    url = "https://github.com/fatih/vim-go"
  },
  ["vim-smoothie"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/vim-smoothie",
  ...
  ["zen-mode.nvim"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/zen-mode.nvim",
...
-- Config for: mongo-nvim
time([[Config for mongo-nvim]], true)
try_loadstring("\27LJ\2\n<\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\1K\0\1\0\nsetup\15mongo-nvim\frequire\0", "config", "mongo-nvim")
time([[Config for mongo-nvim]], false)
