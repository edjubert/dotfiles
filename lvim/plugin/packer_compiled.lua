...
_G.packer_plugins = {
  ...
  ["centerpad.nvim"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/centerpad.nvim",
  ...
  edge = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/edge",
  ...
  neon = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/neon",
  ...
  ["nvim-transparent"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/nvim-transparent",
  ...
  ["onedarkpro.nvim"] = {
    loaded = true,
    path = "/home/edjubert/.local/share/lunarvim/site/pack/packer/start/onedarkpro.nvim",
