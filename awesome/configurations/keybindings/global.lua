...
local globalkeys = gears.table.join(
  ...
  awful.key({ super }, "w", function()
    awful.spawn("brave")
  end, { description = "show firefox", group = "launcher" }),

  -- Layout manipulation
  -- Swap client
  awful.key({ super, shift }, keys.down, function()
    awful.client.swap.byidx(1)
  end, { description = "swap with next client by index", group = "client" }),
  awful.key({ super, shift }, "Left", function()
    awful.client.swap.byidx(1)
  end, { description = "swap with next client by index", group = "client" }),
  awful.key({ super, shift }, keys.up, function()
    awful.client.swap.byidx(-1)
  ...
  awful.key({ super, ctrl }, keys.up, function()
    awful.screen.focus_relative(-1)
  ...
  end, { description = "Launch exit screen", group = "launcher" }),
  -- Client resize master
  awful.key({ super, ctrl }, "Right", function()
    awful.tag.incmwfact(0.05)
  end, { description = "increase master width factor", group = "layout" }),
  awful.key({ super, ctrl }, keys.left, function()
    awful.tag.incmwfact(-0.05)
  ...
  awful.key({ super, ctrl }, keys.down, function()
    awful.client.incwfact(-0.50)
  end, { description = "decrease master width factor", group = "layout" }),
  -- Increase/Decrease numbers of master
  awful.key({ super, shift }, keys.left, function()
    awful.tag.incnmaster(1, nil, true)
  end, { description = "increase the number of master clients", group = "layout" }),
  awful.key({ super, shift }, keys.right, function()
    awful.tag.incnmaster(-1, nil, true)
  ...
  awful.key({ super, shift }, keys.minimize, function()
  ...
  end, { description = "Display configuration", group = "hotkeys" }),
  ...
  awful.key({
    ...
    on_press = function()
      awful.util.spawn(
        'rofi -modi "choose_sink:/home/edjubert/.config/awesome/scripts/sink_chooser" -show choose_sink'
      )
    end,
  }),
  awful.key({
    ...
    on_press = function()
      awful.util.spawn(
        'rofi -modi "choose_source:/home/edjubert/.config/awesome/scripts/source_chooser" -show choose_source'
      )
    end,
  }),
  awful.key({
    ...
    on_press = function()
      awful.util.spawn(
        'rofi -modi "choose_layout:/home/edjubert/.config/awesome/scripts/keyboardLayoutChooser" -show choose_layout'
      )
    end,
  })
)
