...
theme.font_bold = "Iosevka 10"
theme.font_large = "Iosevka 12"
theme.font_large_bold = "Iosevka bold 12"
theme.font_small = "Iosevka 9"
theme.font_extra_small = "Iosevka 9"
theme.taglist_font = "Ubuntu Nerd Font 12"
...
colors.purple = "#da8ee7"
colors.teal = "#008080"
colors.light_teal = "#66b2b2"
...
theme.border_focus  = colors.light_teal
theme.border_marked = colors.red
theme.bg_yellow     = colors.yellow

-- Tasklist colors
theme.bg_tasklist_active = colors.light_teal .. "33"
...
theme.taglist_fg_focus = colors.light_teal
...
theme.tasklist_bg_focus           = colors.light_teal
if theme.mode == "dark" then
